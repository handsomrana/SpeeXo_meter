...
//         // ),
//         // Text(
//         //   'Tunnel Distance: ${controller.tunnelDistance.toStringAsFixed(1)} sec',
//         //   style: TextStyle(fontSize: fontSize),
//         // ),
//         // Text(
//         //   'Tunnel Fare: ${controller.totalTunnelFare.toStringAsFixed(1)} sec',
//         //   style: TextStyle(fontSize: fontSize),
//         // ),
//         // Text(
//         //   'Waiting Fare: ${controller.waitingFare.toStringAsFixed(3)} \$',
...
//         ElevatedButton(
//           onPressed: () {
//             _showAddExtraDialog(context);
//           },
//           child: const Text("Add Extras"),
//         ),
//         const SizedBox(
//           height: 10,
//         ),
//         ElevatedButton(onPressed: () {}, child: const Text("Add Tolls"))
//         // ElevatedButton(
//         //   onPressed: () {
//         //     if (controller.isTunnel) {
//         //       controller.onResumeTracking();
